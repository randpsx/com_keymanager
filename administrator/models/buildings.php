 ...
 */
class KeymanagerModelBuildings extends JModelList {
    ...
    public function __construct($config = array()) {
        if (empty($config['filter_fields'])) {
            $config['filter_fields'] = array(
                ...
                'building_description', 'a.building_description',
                'ordering', 'a.ordering',
                'state', 'a.state',
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        parent::populateState('a.building_name', 'asc');
    }
    ...
    protected function getListQuery() {
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.building_name LIKE '.$search.' )');
            }
        }
