 ...
 */
class KeymanagerModelRooms extends JModelList {
    ...
    public function __construct($config = array()) {
        if (empty($config['filter_fields'])) {
            $config['filter_fields'] = array(
                ...
                'room_description', 'a.room_description',
    ...
    protected function populateState($ordering = null, $direction = null) {
        ...
        parent::populateState('a.room_name', 'asc');
    }
    ...
    protected function getListQuery() {
		...
		$query->select('#__keymanager_buildings_1540165.building_name AS buildings_building_name_1540165');
		$query->join('LEFT', '#__keymanager_buildings AS #__keymanager_buildings_1540165 ON #__keymanager_buildings_1540165.id = a.building_id');
        ...
        if (!empty($search)) {
            if (stripos($search, 'id:') === 0) {
                ...
                $query->where('( a.room_name LIKE '.$search.'  OR  a.room_description LIKE '.$search.' )');
            }
        }
		...
		if ($filter_building_id) {
			$query->where("a.building_id = '".$db->escape($filter_building_id)."'");
		}
