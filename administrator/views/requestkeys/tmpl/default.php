...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_keymanager&task=requestkeys.saveOrderAjax&tmpl=component';
	JHtml::_('sortablelist.sortable', 'requestkeyList', 'adminForm', strtolower($listDirn), $saveOrderingUrl);
}
