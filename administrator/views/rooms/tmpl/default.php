...
if ($saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_keymanager&task=rooms.saveOrderAjax&tmpl=component';
...
<form action="<?php echo JRoute::_('index.php?option=com_keymanager&view=rooms'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php endif;?>
		...
		<table class="table table-striped" id="roomList">
			...
			<?php foreach ($this->items as $i => $item) :
				...
				<?php endif; ?>
				<?php if ($canEdit) : ?>
					<a href="<?php echo JRoute::_('index.php?option=com_keymanager&task=room.edit&id='.(int) $item->id); ?>">
