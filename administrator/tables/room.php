...
class KeymanagerTableroom extends JTable {
    ...
    public function __construct(&$db) {
        parent::__construct('#__keymanager_rooms', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '') {
        ...
        if (!JFactory::getUser()->authorise('core.admin', 'com_keymanager.room.' . $array['id'])) {
            $actions = JFactory::getACL()->getActions('com_keymanager', 'room');
            $default_actions = JFactory::getACL()->getAssetRules('com_keymanager.room.' . $array['id'])->getData();
            $array_jaccess = array();
    ...
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_keymanager.room.' . (int) $this->$k;
    }
