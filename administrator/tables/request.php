...
class KeymanagerTablerequest extends JTable {
    ...
    public function __construct(&$db) {
        parent::__construct('#__keymanager_requests', 'id', $db);
    }
    ...
    public function bind($array, $ignore = '') {
        ...
        if (!JFactory::getUser()->authorise('core.admin', 'com_keymanager.request.' . $array['id'])) {
            $actions = JFactory::getACL()->getActions('com_keymanager', 'request');
            $default_actions = JFactory::getACL()->getAssetRules('com_keymanager.request.' . $array['id'])->getData();
            $array_jaccess = array();
  ...
  public function load($keys = Null, $reset = true) {
    ...
    protected function _getAssetName() {
        $k = $this->_tbl_key;
        return 'com_keymanager.request.' . (int) $this->$k;
    }
